...
<section id="main" class="entire_width">
    <div class="container_12">      
       <div id="content">
		<div class="grid_12">
			<h1 class="page_title">登录或注册一个用户</h1>
		</div><!-- .grid_12 -->
		
		<div class="grid_6 new_customers">
			<h2>新用户</h2>
			<p>当您创建一个商城新用户的时候，你可以更快速地支付，存储多个邮寄地址，设置头像等更多的功能。 </p>
			<div class="clear"></div>
			<button class="account">创建新用户</button>
                </div><!-- .grid_6 -->
		
		<div class="grid_6">
			<form class="registed" method="psot" 
				action="${pageContext.request.contextPath }/dopages/dologin.jsp">
				<h2>登录</h2>
				...
				<div class="email">
					...
					<input type="text" name="username" class="" value="请输入用户名" />
				</div><!-- .email -->
