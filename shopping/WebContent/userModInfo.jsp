...
<%} else {%>
  ...
  <section id="main">
    <div class="container_12">
       ...
       <div id="content" class="grid_9">
		<h1 class="page_title">修改信息</h1>
		<article class="post">
		  <h2 class="title_article">修改信息</h2>
			<div class="content_article">
				<p>
					用户名：<%=session.getAttribute("loginuser")%><br>
		...
		<article class="post">
		  <h2 class="title_article">修改密码</h2>
			<div class="content_article">
				<p>
					<form method="post" action="${pageContext.request.contextPath }/dopages/doModifyPassword.jsp">
						旧密码:<input type="text" name="oldpwd"/><%if(request.getAttribute("oldpwdError")!=null){out.print(request.getAttribute("oldpwdError"));} %><br />
						新密码:<input type="text" name ="newpwd1" /><br />
						确认新密码:<input type="text" name ="newpwd2" /><%if(request.getAttribute("pwdChangeError")!=null){out.print(request.getAttribute("pwdChangeError"));} %><br />
